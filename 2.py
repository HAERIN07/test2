...
def draw_board():
    ...
    for i in range(1, 3):  # 범위 변경
        pygame.draw.line(screen, LINE_COLOR, (0, i * 100), (300, i * 100), 3)  # 좌표 및 선 굵기 변경
    # 세로 선
    for i in range(1, 3):  # 범위 변경
        pygame.draw.line(screen, LINE_COLOR, (i * 100, 0), (i * 100, 300), 3)  # 좌표 및 선 굵기 변경
    # 현재 상태 표시
        ...
        if event.type == pygame.QUIT:
            ...
            if board[row][col] == ' ':
                ...
                if check_win(current_player):
                    draw_board()
                    pygame.display.flip()
                    font = pygame.font.SysFont(None, 40)  # 폰트 크기 변경
